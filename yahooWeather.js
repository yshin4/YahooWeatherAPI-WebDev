...
var getForecast = function() {
    ...
    $.get('https://query.yahooapis.com/v1/public/yql', {
        ...
        if (!data.query.results) {
            ...
            $('.result-container2').html('<p>' + "Chill: " + dataChannel.wind.chill + "°" + dataChannel.units.temperature + '</p>' +
            '<p>' + "Direction: " + dataChannel.wind.direction + "°" + dataChannel.units.temperature + '</p>' +
